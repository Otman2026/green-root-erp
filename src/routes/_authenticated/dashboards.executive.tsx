  ...
  useEffect(() => {
    (async () => {
      ...
      const [
        ...
        supabase.from("products").select("id,name,stock_quantity,min_stock_alert").eq("is_active", true),
        supabase.from("products").select("id,name,stock_quantity,min_stock_alert").eq("is_active", true).limit(500),
