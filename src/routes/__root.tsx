...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AgriERP — نظام إدارة تجارة المستلزمات الزراعية" },
      { name: "description", content: "منصة ERP احترافية لإدارة محلات وشركات بيع الأسمدة والمبيدات والبذور والمعدات الزراعية." },
      { name: "author", content: "AgriERP" },
      { property: "og:title", content: "AgriERP — Agricultural Supplies ERP" },
      { property: "og:description", content: "Professional ERP platform for fertilizers, pesticides, seeds and agricultural equipment trade." },
